...
###Random Forest##############################################################
##All from LM2
forestModel2<-randomForest(formula=NumReserveDays2016Q3 ~ meanPriceQ1+NumberofReviews+ OverallRating + 
                             CleanRating + CheckinRating + ValueRating + MaxGuests + ResponseTimemin +MinimumStay + BusinessReady+BookingQ2+BookingQ1+BookedQ1+BookedQ2,data=property_info_train,ntree=1000,mtry=4,nodesize=7,importance=TRUE)
...
NewTest<-rfFunction(c("meanPriceQ1","OverallRating","CleanRating","CheckinRating","ValueRating","MaxGuests","ResponseTimemin","NumberofReviews","MinimumStay","BusinessReady","BookingQ2","BookingQ1"),1000)
...
plot(c(NewTest1,NewTest2,NewTest3,NewTest4,NewTest5,NewTest6,NewTest7,NewTest8))
